      ...
      <div className={panelStyle} style={SummaryPanelClusterBox.panelStyle}>
        ...
        <div className={summaryBodyTabs}>
          <SimpleTabs id="graph_summary_tabs" defaultTab={0} style={{ paddingBottom: '10px' }}>
            <Tooltip id="tooltip-inbound" content={$t('tip53')} entryDelay={1250} triggerRef={tooltipInboundRef} />
            <Tooltip id="tooltip-outbound" content={$t('tip54')} entryDelay={1250} triggerRef={tooltipOutboundRef} />
            <Tooltip id="tooltip-total" content={$t('tip55')} entryDelay={1250} triggerRef={tooltipTotalRef} />
