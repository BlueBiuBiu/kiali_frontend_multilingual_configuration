  ...
  private getMenuOptions() {
    ...
    const edgeLabelOptions: DisplayOptionType[] = [
      ...
      },
      {
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip314')}</div>
      },
      {
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip315')}</div>
      }
    ];
    ...
    const throughputOptions: DisplayOptionType[] = [
      {
        ...
        labelText: 'Request',
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip316')}</div>
      },
      {
        ...
        labelText: 'Response',
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip317')}</div>
      }
    ];
    ...
    const responseTimeOptions: DisplayOptionType[] = [
      {
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip318')}</div>
      },
      {
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip319')}</div>
      },
      {
        ...
        isDisabled: this.state.crippledFeatures?.responseTimePercentiles,
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip320')}</div>
      },
      {
        ...
        isDisabled: this.state.crippledFeatures?.responseTimePercentiles,
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip321')}</div>
      }
    ];
    ...
    const visibilityOptions: DisplayOptionType[] = [
      {
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip322')}</div>
      },
      {
        id: 'boxByNamespace',
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip323')}</div>
      },
      {
        id: 'filterHide',
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip324')}</div>
      },
      {
        id: 'filterIdleEdges',
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip325')}</div>
      },
      {
        id: 'filterIdleNodes',
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip326')}</div>
      },
      {
      ...
      },
      {
        ...
        labelText: 'Rank',
        onChange: toggleRank,
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip331')}</div>
      },
      {
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip332')}</div>
      },
      {
        ...
        tooltip: <div style={{ textAlign: 'left' }}>{$t('tip333')}</div>
      }
    ];
    ...
    return (
      ...
      >
        <div id="graph-display-menu" className={menuStyle} style={{ width: '15em' }}>
          ...
          <div className={titleStyle}>{$t('ShowBadges')}</div>
