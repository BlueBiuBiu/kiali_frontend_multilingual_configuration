          ...
          <ToolbarGroup aria-label="graph settings" style={{ margin: 0, alignItems: 'flex-start' }}>
            {this.props.node && (
              <ToolbarItem style={{ margin: 0 }}>
                <Tooltip key={'graph-tour-help-ot'} position={TooltipPosition.right} content={$t('tip351')}>
            ...
            <ToolbarItem style={{ marginLeft: 'auto', alignSelf: 'center' }}>
              <Tooltip key={'graph-tour-help-ot'} position={TooltipPosition.right} content={$t('placeholder42')}>
