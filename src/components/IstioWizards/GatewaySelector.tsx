  ...
  render() {
    return (
      <Form isHorizontal={true}>
        <FormGroup label={$t('AddGateway')} fieldId="gatewaySwitch">
          <Switch
          ...
          <>
            <FormGroup fieldId="includeMesh">
              ...
              {!isValid(this.isMeshGatewayValid()) && (
                <FormHelperText>
                  <HelperText>
                    <HelperTextItem>{$t('helpTip8')}</HelperTextItem>
                  </HelperText>
                </FormHelperText>
              )}
            </FormGroup>
            ...
            {!this.state.newGateway && (
              <FormGroup fieldId="selectGateway" label={$t('Gateway')}>
                ...
                {this.props.gateways.length === 0 && <>{$t('tip298')}</>}
              </FormGroup>
            )}
            {this.state.newGateway && (
              <>
                ...
                <FormGroup fieldId="gwHosts" label={$t('Gateway Hosts')}>
                  ...
                  <FormHelperText>
                    <HelperText>
                      <HelperTextItem>
                        {isValid(this.state.gwHostsValid) ? $t('helpTip9') : $t('helpTip10')}
                      </HelperTextItem>
                    </HelperText>
                  </FormHelperText>
                </FormGroup>
