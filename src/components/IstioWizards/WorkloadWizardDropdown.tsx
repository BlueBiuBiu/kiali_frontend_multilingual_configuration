...
export const WorkloadWizardDropdown: React.FC<Props> = (props: Props) => {
  ...
  const renderDropdownItems = (): JSX.Element[] => {
    ...
    if (serverConfig.kialiFeatureFlags.istioInjectionAction) {
      ...
      const enableActionWrapper = serverConfig.deployment.viewOnlyMode
        ? renderDisabledDropdownOption('enable_auto_injection', TooltipPosition.left, $t('helpTip22'), enableAction)
        : enableAction;
      ...
      const disableActionWrapper = serverConfig.deployment.viewOnlyMode
        ? renderDisabledDropdownOption('disable_auto_injection', TooltipPosition.left, $t('helpTip22'), disableAction)
        : disableAction;
      ...
      const removeActionWrapper = serverConfig.deployment.viewOnlyMode
        ? renderDisabledDropdownOption('remove_auto_injection', TooltipPosition.left, $t('helpTip22'), removeAction)
        : removeAction;
  ...
  return (
    <>
      ...
      />
      {!validActions
        ? renderDisabledDropdownOption('tooltip_wizard_actions', TooltipPosition.top, $t('tip22'), dropdown)
        : dropdown}
    </>
  );
};
