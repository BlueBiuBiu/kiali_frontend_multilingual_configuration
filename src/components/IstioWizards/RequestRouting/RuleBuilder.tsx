    ...
    return (
      <>
        <Tabs isFilled={true} activeKey={this.state.ruleTabKey} onSelect={this.ruleHandleTabClick}>
          <Tab eventKey={0} title={$t('RequestMatching')} data-test={'Request Matching'}>
            <div style={{ marginTop: '20px' }}>
              <MatchBuilder {...this.props} />
              <Matches {...this.props} />
            </div>
          </Tab>
          <Tab eventKey={1} title={$t('RouteTo')} data-test={'Route To'}>
            <div
              style={{
                marginBottom: '10px'
              }}
          ...
          <Tab eventKey={2} title={$t('FaultInjection')} data-test={'Fault Injection'}>
          ...
          <Tab eventKey={3} title={$t('RequestTimeouts')} data-test={'Request Timeouts'}>
            <div style={{ marginTop: '10px' }}>
              <RequestTimeouts
