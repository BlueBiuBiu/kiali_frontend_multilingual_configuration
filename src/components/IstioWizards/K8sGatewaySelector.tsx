  ...
  render() {
    return (
      <Form isHorizontal={true}>
        <FormGroup label={$t('AddK8sAPIGateway')} fieldId="gatewaySwitch">
          <Switch
          ...
          <>
            ...
            {!this.state.newGateway && (
              <FormGroup fieldId="selectGateway" label={$t('K8sGateway')}>
                ...
                {this.props.k8sGateways.length === 0 && <>{$t('tip297')}</>}
              </FormGroup>
            )}
            {this.state.newGateway && (
              <>
                {serverConfig.gatewayAPIClasses.length > 1 && (
                  <FormGroup label={$t('GatewayClass')} fieldId="gatewayClass">
                    <FormSelect
                ...
                <FormGroup fieldId="gwHosts" label={$t('K8sAPIGatewayHosts')}>
                  <TextInput
                    id="gwHosts"
                    name="gwHosts"
                    isDisabled={!this.state.addGateway || !this.state.newGateway}
                  ...
                  <FormHelperText>
                    <HelperText>
                      <HelperTextItem>
                        {isValid(this.state.gwHostsValid) ? $t('helpTip9') : $t('helpTip14')}
                      </HelperTextItem>
                    </HelperText>
                  </FormHelperText>
                </FormGroup>
